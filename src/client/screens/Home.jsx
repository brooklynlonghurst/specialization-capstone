    ...
    return (
        <div className='home-container'>
            ...
            <div className='home-page-card'>
                ...
                <GameCard title={'Create Your Constellation'} img={<img className='game-card-img' src='https://s3.us-east-1.amazonaws.com/s3.discoveryplace.org/craft3/_mediumWidth/Constellations-shutterstock_267383846.jpg' alt='constellation img'/> } />        
            </div>
        </div>
    )
}
